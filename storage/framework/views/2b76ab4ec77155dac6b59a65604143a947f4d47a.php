...
<body>
    ...
    <table cellspacing="0" cellpadding="10" style="border: 1px solid; width: 80%; margin-left:auto; margin-right:auto;">
        ...
        <tbody>
            ...
            <td><?php echo e($data[0]->client_surname); ?> <?php echo e($data[0]->client_name); ?> <?php echo e($data[0]->client_patronymic); ?></td>
            </tr>
            <tr>
            <th scope="row" style="text-align:end; width: 30%">Туристы</th>
            <td><?php echo e($data[0]->participant_fullname); ?> </td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellspacing="0" cellpadding="10" style="border: 1px solid; width: 80%;margin-left:auto; margin-right:auto;">
        ...
        <tr>
            ...
            <td>С <?php echo e($data[0]->start_of_trip); ?> по <?php echo e($data[0]->end_of_trip); ?></td>
            </tr>
            <tr>
            <th scope="row" style="text-align:end; width: 30%">Страна</th>
            <td><?php echo e($data[0]->name_country); ?>: <?php echo e($data[0]->name_city); ?></td>
            </tr>
            <tr>
            <th scope="row" style="text-align:end; width: 30%">Вид транспорта</th>
            <td><?php echo e($data[0]->type_of_transport); ?></td>
            </tr>
            <tr>
            ...
            <td> <?php echo e($data[0]->transfer); ?></td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellspacing="0" cellpadding="10" style="border: 1px solid;width: 80%;margin-left:auto; margin-right:auto; ">
        ...
        <tbody>
            <tr>
                ...
                <td><?php echo e($data[0]->name_hotel); ?> <?php echo e($data[0]->address); ?></td>
                <td>Номер: <?php echo e($data[0]->type_room); ?> </br> Питание: <?php echo e($data[0]->type_food); ?></td>
            </tr>
            <tr>
...
</html><?php /**PATH /Users/macbookpro16/Downloads/laba5/orkis_web/resources/views/voucher/get.blade.php ENDPATH**/ ?>