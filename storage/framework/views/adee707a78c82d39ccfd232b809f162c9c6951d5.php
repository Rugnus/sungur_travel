...
<form method="post" action="/contract" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <select id="organization" name='organization' class="form-select" style="border-radius: 15px;" aria-label="Default select example" required id='organization'>
        </select>
    </div>
    <div class="mb-3">
        <label for="agent" class="form-label">Агент:</label>
        <select id="agent" name='agent' class="form-select" style="border-radius: 15px;" aria-label="Default select example" required >
        </select>
    </div>
    <div class="mb-3">
        <label for="client" class="form-label">Клиент:</label>
        <select id="client" name='client' class="form-select" style="border-radius: 15px;" aria-label="Default select example" required >
        </select>
    </div>
    <div class="mb-3">
        <label for="country" class="form-label">Страна:</label>
        <select id="country" name='country' class="form-select" style="border-radius: 15px;" aria-label="Default select example" required >
        </select>
    </div>
    <div class="mb-3">
        <label for="city" class="form-label">Город(а):</label>
        <select id="city" name='city' class="form-select" style="border-radius: 15px;" aria-label="Default select example" required >
        </select>
    </div>
     <div class="mb-3 ">
    <label class="form-label">Гостиниц(а/ы):</label>
            <div class="d-flex flex-row justify-content-between bd-highlight mb-3">
                <div class='flex-fill'>
                    <select id="hotel" name='hotel' class="form-select" style="border-radius: 15px;" style='background-color: rgb(234, 237, 240);' aria-label="Default select example"  >
    ...
    <div class="mb-3">
        ...
        <select id="type_room" name='type_room' style="border-radius: 15px;" class="form-select" aria-label="Default select example" required >
    ...
    <div class="mb-3">
        ...
        <select id="type_food" name='type_food' style="border-radius: 15px;" class="form-select" aria-label="Default select example" required >
    ...
    <div class="mb-3">
        ...
        <input type="text" value="" style="border-radius: 15px;" name="type_transport" id="type_transport" class="form-control" placeholder="Самолет/Поезд/Карета">
    </div>
    <div class="mb-3">
        <label for="transfer" class="form-label">Трансфер:</label>
        <select id="transfer" name='transfer' style="border-radius: 15px;" class="form-select" aria-label="Default select example" required>
    ...
    <div class="mb-3">
        ...
        <input type="date" value="" style="border-radius: 15px;" name="start_trip" id="start_trip" class="form-control">
    </div>
    <div class="mb-3">
        <label for="end_trip" class="form-label">Конец поездки:</label>
        <input type="date" value="" name="end_trip" style="border-radius: 15px;" id="end_trip" class="form-control">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" name='amount_in_currency' style="border-radius: 15px;" class="form-control" id="amount_in_currency" placeholder="000000.00">
    </div>
