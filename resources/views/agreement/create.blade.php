...
<form method="post" action="/agreement" enctype="multipart/form-data">
    ...
    <div class="md-3">
        <button type="submit" class="btn" style="padding: 10px; background-color: #2C2891; border-radius: 15px; box-shadow: 0px 4px 12px 2px rgba(34, 60, 80, 0.4); color: white">Добавить</button>
        <a href="/agreement" class="btn" style="padding: 10px; background-color: #FFCC1D; border-radius: 15px; box-shadow: 0px 4px 12px 2px rgba(34, 60, 80, 0.4); color: white">Отменить</a>
    </div>
</form>
