    ...
    <div class='container p-4' style="margin-bottom: 100px;">
        <div class="row">
            <div class="d-flex flex-row justify-content-between bd-highlight col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn" href="{{ route('employees.index') }}" style="padding: 10px; background-color: #FFA400; border-radius: 15px; box-shadow: 0px 4px 12px 2px rgba(34, 60, 80, 0.4); color: #fff;">Вернуться назад <i class="fas fa-sign-out-alt"></i></a>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('employees.update',$employee->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="mb-3">
                        <strong>Имя:</strong>
                        <input type="text" name="name" value="{{ $employee->name }}" class="form-control" style="border-radius: 15px;">
                </div>
                <div class="mb-3">
                        <strong>Фамилия:</strong>
                        <input type="text" name="surname" value="{{ $employee->surname }}" class="form-control" style="border-radius: 15px;" >
                </div>
                <div class="mb-3">
                    <div class="form-group">
                        <strong>Отчество:</strong>
                        <input type="text" name="patronymic" value="{{ $employee->patronymic }}" class="form-control" style="border-radius: 15px;">
                    </div>
                </div>
                <div class="mb-3">
                    <div class="form-group">
                        <strong>Дата рождения:</strong>
                        <input type="date" name="bth" value="{{ $employee->bth }}" class="form-control" style="border-radius: 15px;">
                    </div>
                </div>
                <div class="mb-3">
                    <div class="form-group">
